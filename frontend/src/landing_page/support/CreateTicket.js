        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i className="fa fa-plus-circle fa-lg"></i> Account Opening</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <h4 className='mb-3'><i className="fa fa-user fa-lg"></i> Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <h4 className='mb-3'><i className="fa fa-bar-chart fa-lg"></i> Kite</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i className="fa fa-credit-card fa-lg"></i> Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i className="fa fa-circle-o fa-lg"></i> Console</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='mb-3'><i className="fa fa-circle-o fa-lg"></i> Coin</h4>
                    ...
                    <a href='' style={{ textDecoration: 'none', lineHeight: 2.5 }}>Starting a SIP</a><br />
